...
void UIManager::DrawControlGuide()
{
	...
	DrawExtendGraph(GUIDE_ICON_X, GUIDE_ROW1_Y, GUIDE_ICON_X + GUIDE_ICON_SIZE, GUIDE_ROW1_Y + GUIDE_ICON_SIZE, _guideAButtonH, true);
	...
	DrawExtendGraph(GUIDE_ICON_X, GUIDE_ROW3_Y, GUIDE_ICON_X + GUIDE_ICON_SIZE, GUIDE_ROW3_Y + GUIDE_ICON_SIZE, _guideYButtonH, true);
